...
class Register extends React.Component {
  ...
  render() {
    return (
        <div>
        <article className="br3 ba b--white-10 mv4 w-100 w-50-m w-25-l mw5 shadow-5 center">
           <main className="pa4 black-80">
              <form className="measure">
                ...
                <div className="">
                  <input
                    className="b white ph3 pv2 input-reset ba b--white hover-bg-black bg-transparent grow pointer f6 dib"
                    type="submit"
